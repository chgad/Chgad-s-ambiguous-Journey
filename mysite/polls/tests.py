...
def create_question(question_text, days):
    ...
    negative for questions published in the past, positive for questions that have yet to pe published).
    :param question_text:
    :param days: 
    :return: 
    """
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_future_question(self):
        """
        Questions with pub-date in the future should not be displayed on the index page.
        :return: 
        """
    ...
    def test_index_view_wiht_future_and_past_question(self):
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_future_question(self):
        """
        The detail view of a question with a pub_date in the future should not display the question's text.
        :return: 
        """
